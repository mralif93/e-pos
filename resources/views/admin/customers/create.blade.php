        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <form action="{{ route('admin.customers.store') }}" method="POST">
                ...
                <div class="px-6 py-4 border-t border-gray-100 flex justify-end gap-3 items-center">
                    <a href="{{ route('admin.customers.index') }}" class="inline-flex items-center justify-center gap-1.5 rounded-lg text-sm font-medium transition-all active:scale-95 border focus:outline-none px-4 py-2.5 bg-white text-gray-700 border-gray-300 hover:bg-gray-50 shadow-sm">
                        Cancel
                    </a>
